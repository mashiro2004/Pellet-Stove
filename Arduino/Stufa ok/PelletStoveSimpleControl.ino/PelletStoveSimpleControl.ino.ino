...
const char* ssid = "Vodafonemashy_home";
const char* password = "eleonora08";

// Page password
String pinPs=""; // your *numeric* pin/password for accessing the page, leave blank if you don't want a pin
...
// data used for static IP configuration
  ...
  IPAddress ip(192,168,4,101); // board address
  IPAddress gateway(192,168,4,1); // router address
#endif
