...
$sqlins = "INSERT INTO mercoledi (inizio1,inizio2,inizio3,fine1,fine2,fine3) VALUES ('$in1','$in2','$in3','$fi1','$fi2','$fi3')";
...
if ($reviniziom1 == '' || $reviniziom1 == ' ') {
   ...
   $lines[13] = $reviniziom1 . ' * * 3 /bin/sh /tmp/launch.sh';
}
if ($revfinem1 == '' || $revfinem1 == ' ') {
   $lines[14] = '#14 - Mercoledi Fine';
} else {
   $lines[14] = $revfinem1 . ' * * 3 /bin/sh /tmp/launch.sh';
}
if ($reviniziom2 == '' || $reviniziom2 == ' ') {
   $lines[15] = '#15 - Mercoledi Inizio';
} else {
   $lines[15] = $reviniziom2 . ' * * 3 /bin/sh /tmp/launch.sh';
}
if ($revfinem2 == '' || $revfinem2 == ' ') {
   $lines[16] = '#16 - Mercoledi Fine';
} else {
   $lines[16] = $revfinem2 . ' * * 3 /bin/sh /tmp/launch.sh';
}
if ($reviniziom3 == '' || $reviniziom3 == ' ') {
   $lines[17] = '#17 - Mercoledi Inizio';
} else {
   $lines[17] = $reviniziom3 . ' * * 3 /bin/sh /tmp/launch.sh';
}
if ($revfinem3 == '' || $revfinem3 == ' ') {
   $lines[18] = '#18 - Mercoledi Fine';
} else {
   $lines[18] = $revfinem3 . ' * * 3 /bin/sh /tmp/launch.sh';
}
